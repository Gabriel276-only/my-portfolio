...
const TechIcons = () => {
  return (
    <div className="grid grid-cols-5 sm:grid-cols-5 md:grid-cols-5 lg:grid-cols-5 justify-center p-2 gap-10 w-80 md:w-full md:p-6 bg-purple-800/20 rounded-lg shadow-lg border-2 border-purple-400 ">
      {[ 
