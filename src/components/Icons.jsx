...
const TechIcons = () => {
  return (
    <div className="grid grid-cols-5 sm:grid-cols-5 md:grid-cols-5 lg:grid-cols-5 justify-center p-2 gap-10 w-80 md:w-full md:p-6 bg-gradient-to-br from-purple-900 to-fuchsia-800/20 backdrop-blur-2xl  rounded-xl border-b-4 border-2 border-fuchsia-500/70  ">
      {[ 
