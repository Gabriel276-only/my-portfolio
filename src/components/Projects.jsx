...
const projects = [
  ...
  { id: 3, title: "Forms-React - Sistema de Login, Verificação e Hospedagem de Quartos", link: "https://github.com/Gabriel276-only/forms-react", image: Projeto3 },
  { id: 4, title: "NIKE-CLONE - um exemplo de clone da página web da Nike", link: "https://github.com/Gabriel276-only/NIKE-CLONE", image: Projeto4 },
  { id: 5, title: "Spotify-Clone - um exemplo de clone do spotify com Next.js", link: "https://github.com/Gabriel276-only/NIKE-CLONE", image: Projeto5 },
    ...
    <section className="relative min-h-screen w-full flex flex-col md:flex-row items-center p-8 gap-6 overflow-hidden">
      ...
      <section className="relative flex flex-col items-center md:items-start w-full md:w-1/3">
        <div className="flex flex-1 items-center z-10 w-full justify-center md:justify-start mb-8 md:mb-0">
          <h2 className="relative mt-0 whitespace-nowrap text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-black text-purple-400 md:right-80 md:-rotate-90 md:leading-none" data-aos="fade-right">
            MY PROJECTS
          </h2>
        </div>
      </section>
